...
public class HttpClient {
    ...
    private final OkHttpClient okHttp = new OkHttpClient.Builder().connectTimeout(800, TimeUnit.SECONDS).writeTimeout(800, TimeUnit.SECONDS).readTimeout(800, TimeUnit.SECONDS).build();
